...
wp_enqueue_style("style-admin",get_bloginfo('stylesheet_directory')."/functions/options/style.css");
}
...
function tie_post_options_module(){
	...
	<div class="tiepanel-item" id="tie_post_head_options_box">
		<h3><?php _e( 'Post Head Options', 'rsnews' ) ?></h3>
		
		<?php			
		tie_post_meta_box(				
			array(	"name"		=> __( 'Display', 'rsnews' ),
					"id"		=> "tie_post_head",
					"type"		=> "select",
					"options"	=> array(
						''				=> __( 'Default', 'rsnews' ),
        ...
        tie_post_meta_box(				
			array(	"name"	=> __( 'Embed Code', 'rsnews' ),
					"id"	=> "tie_embed_code",
					"type"	=> "textarea"));
		...
		tie_post_meta_box(				
			array(	"name"	=> __( 'Video URL <br/><small>supports : YouTube, Vimeo, Viddler, Qik, Hulu, FunnyOrDie, DailyMotion, WordPress.tv and blip.tv</small><br />', 'rsnews' ),
					...
					"type"	=> "text"));
        tie_post_meta_box(				
			array(	"name"	=> __( 'Self Hosted Video', 'rsnews' ),
					"id"	=> "tie_video_self",
					"type"	=> "text"));
	...
	<div class="tiepanel-item" id="tie_sidebar_options_box">
		<h3><?php _e( 'Post settings', 'rsnews' ) ?></h3>
        
        
        <?php
        //views				
		tie_post_meta_box(				
			array(	"name"	=> __( 'Views', 'rsnews' ),
					"id"	=> "views",
					"type"	=> "text"));
        ...
        //tie_views 
        tie_post_meta_box(				
			array(	"name"	=> __( 'tie_views', 'rsnews' ),
					"id"	=> "tie_views",
					"type"	=> "text"));           
        ?>
        </div>
