...
class Underscores_Generator_Plugin {
	...
	function underscoresme_print_form() {
        ...
        <article id="bform" class="boxgenform">
		<div id="generator-form" class="generator-form-skinny">
			<form method="POST">
                ...
                <div class="col-md-8 col-sm-8 col-xs-12 no-padding" style="margin-bottom: 15px;">
				<section class="generator-form-inputs">
					<section class="generator-form-primary">
						<input type="text" id="underscoresme-name" name="underscoresme_name" placeholder="Имя Темы" />
					</section><!-- .generator-form-primary -->

					<section class="generator-form-secondary">
						<input type="text" id="underscoresme-slug" name="underscoresme_slug" placeholder="Slug темы" />
						<input type="text" id="underscoresme-author" name="underscoresme_author" placeholder="Автор" />
						<input type="text" id="underscoresme-author-uri" name="underscoresme_author_uri" placeholder="URI автора" />
						<input type="text" id="underscoresme-description" name="underscoresme_description" placeholder="Описание" />
						
                        <div class="checkbox">
                            <input type="checkbox" id="underscoresme-woocommerce" name="underscoresme_woocommerce" value="1">
    						<label style="display: inline;color: burlywood;" for="underscoresme-woocommerce">WooCommerce образец</label>
                        </div>
                        <div class="checkbox">
    						<input type="checkbox" id="underscoresme-sass" name="underscoresme_sass" value="1">
    						<label style="display: inline;color: burlywood;" for="underscoresme-sass">_sassify!</label>
                        </div>
				...
				<div class="generator-form-submit col-md-4 col-sm-4 col-xs-12 no-padding-right xs-no-padding-left ">
					<input type="submit" name="underscoresme_generate_submit" value="Старт"/>
					<span class="generator-form-version"><a style="color: burlywood;" target="_blank" href="http://github.com/pomerla/_s-rus">_s-rus на github</a></span>
